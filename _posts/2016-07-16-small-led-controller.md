...
- Connectors for up to 2 clockless LED strips (although fitting the wires in the tiny case will be tricky with 2).
...
A [nibbling tool](https://www.amazon.com/s/ref=nb_sb_noss?url=search-alias%3Daps&field-keywords=nibbling+tool) made it very easy to make the side cuts in the case.
